...
RESTORE_SERVICES="${12:-}"
MAX_SECONDS="${13:-1800}"
ENGINE_START_DELAY="${SBSC_ENGINE_START_DELAY:-${FORKOP_SC_ENGINE_START_DELAY:-1}}"
SCAN_POLL_SECONDS="${SBSC_SCAN_POLL_SECONDS:-${FORKOP_SC_SCAN_POLL_SECONDS:-2}}"
FINALIZER="${SBSC_FINALIZER:-${FORKOP_SC_FINALIZER:-/usr/bin/sing-box-service-check}}"
