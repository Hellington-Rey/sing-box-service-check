...
function vpn_status(protocol) {
    ...
    let awg_i_ready = protocol != "amneziawg" ||
        (proto_ready && index(as_string(fs.readfile(proto_path)), "awg_i1") >= 0);
    let issues = [];
